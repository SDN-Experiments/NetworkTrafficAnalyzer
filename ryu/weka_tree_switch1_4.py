...
class WekaTreeSwitch2(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]

    def __init__(self, *args, **kwargs):
        super(WekaTreeSwitch2, self).__init__(*args, **kwargs)
        self.mac_to_port = {}
        self.host2host_instance = {}
	self.label_flow={'web':[],'dns':[],'ftp':[],'p2p':[], 'ssl' : []}
	...
	#weka_decision_tree(self, tamtotal_med_pacote, desv_padrao_tamtotal, variancia_tamtotal, tamtotal_pacote_maior, tamtotal_pacote_menor, com_med_cabecalhoIP, codigo_protocolo, srcporta, dstporta)
		        fluxo_classe = self.weka_decision_tree(h2h.median_packet_size,
	...
	if fluxo_classe_temp != None:
		self.label_flow[fluxo_classe_temp].append(h2h)
		for rotul_flow in self.label_flow:
		    print rotul_flow + ' = ' +  str(len(self.label_flow[rotul_flow]))
