...
class QosWekaTreeSwitch3(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]

    def __init__(self, *args, **kwargs):
        super(QosWekaTreeSwitch3, self).__init__(*args, **kwargs)
        self.mac_to_port = {}
    ...
    def _packet_in_handler(self, ev):
        ...
        #self.logger.debug("[INFO] - ( Checking ether type is ip... ) ")
        if eth.ethertype == ether_types.ETH_TYPE_IP:
	    #self.logger.debug("[INFO] - ( ok, is ip! ) ")
